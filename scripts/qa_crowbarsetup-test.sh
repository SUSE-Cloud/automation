...
verlist="3 4 5 5minus 9 4plus 9M4plus 9M4minus"
export cloud=x
...
it_returns_correct_cloudver_matrix_milestone() {
    results=`cloudversionmatrix "M3 M4 M5 Beta3 Beta4 RC3 GMC susecloud9 GM9+up"`
    test "$results" = " M3=11110010 M4=11110000 M5=11110001 Beta3=11110001 Beta4=11110001 RC3=11110001 GMC=11110001 susecloud9=11110001 GM9+up=11110001"
}
