...
function addslesrepos {
    ...
    12.*)
        ...
        ;;
    *)
        for prod in SLE-Product-SLES SLE-Module-Basesystem SLE-Module-Legacy SLE-Module-Development-Tools SLE-Module-Server-Applications SLE-Module-Desktop-Applications; do
