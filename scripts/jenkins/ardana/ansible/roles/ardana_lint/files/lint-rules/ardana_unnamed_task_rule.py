...
class ArdanaUnnamedTaskRule(AnsibleLintRule):
    id = 'ARDANAANSIBLE0005'
    shortdesc = 'Unnamed Task'
    description = 'All actions must have a name.'
    tags = ['formatting']
...
class ardana_unnamed_task_rule(ArdanaUnnamedTaskRule):
    pass
