...
class ArdanaLineLengthRule(AnsibleLintRule):
    id = 'ARDANAANSIBLE0003'
    shortdesc = 'WARNING - Line length > 80 chars'
    description = 'Attempt to keep all lines shorter than 80 characters ' + \
...
class ardana_line_length_rule(ArdanaLineLengthRule):
    pass
