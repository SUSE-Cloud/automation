...
EOPYTHON
    ...
    if [[ $cloud = u1 ]] ; then
        ...
        /opt/dell/bin/json-edit -a attributes.network.networks.public.broadcast -v 10.84.211.255 $netfile
        /opt/dell/bin/json-edit -a attributes.network.networks.public.ranges.host.start -v 10.84.208.1 $netfile
        ...
        /opt/dell/bin/json-edit -a attributes.network.networks.nova_floating.router -v 10.84.212.1 $netfile
