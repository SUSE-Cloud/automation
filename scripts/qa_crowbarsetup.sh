...
function oncontroller_setupproduction()
{
    ...
    # import images
    for img in SLES12.qcow2 SLES12-SP1.qcow2 SLES12-SP2.qcow2 x86_64/SP4-64up.qcow2 cirros-0.3.4-x86_64-disk.img other/openSUSE-Leap-42.1.qcow2 other/openSUSE-Leap-42.1-OpenStack.x86_64-0.0.3-Build1.2.qcow2 Fedora-x86_64-20-20131211.1-sda.qcow2 ; do
