...
function oncontroller_setupproduction()
{
    ...
    for prj in $(curl https://w3.suse.de/~bwiedemann/cloud/projects.txt) container-ci ; do
        ...
        neutron quota-update --tenant-id $tenantid --floatingip 50 --security-group -1 --port 150 --network 50 --router 50 --pool 50
    ...
    openstack user create --project ecosystem --email framalho@suse.com ecosystem-ci
    openstack role add --project ecosystem --user ecosystem-ci Member
...
{
    for img in SLES12.qcow2 SLES12-SP1.qcow2 SLES12-SP2.qcow2 SLES12-SP3.qcow2 SP4-64up.qcow2 cirros-0.3.4-x86_64-disk.img openSUSE-Leap-42.1.qcow2 openSUSE-Leap-42.1-OpenStack.x86_64.qcow2 openSUSE-Leap-42.2-OpenStack.x86_64.qcow2 openSUSE-Leap-42.3-OpenStack.x86_64.qcow2 openSUSE-Leap-15.0-OpenStack.x86_64.qcow2 Fedora-x86_64-20-20131211.1-sda.qcow2 ubuntu-16.04-server-cloudimg-amd64-disk1.img debian-jessie-nopart.qcow2 debian-9-openstack-amd64.qcow2 openSUSE-Leap-42.2-altimagebuild.qcow2 SLES12-SP3-OpenStack.x86_64-0.4.0-Build1.18.qcow2 ; do
